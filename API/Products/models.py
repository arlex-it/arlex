...
products_create = api.model('Product create', {
    'expiration_date': NullableString(example='2019-11-30', description='Date expiration produit', required=True, nullable=True),
    'id_arlex': fields.String(example='15151-AZDAZD-515451', description='Id du patch RFID du produit', required=True),
